 ...
 */
public class RequestEcoMaxControl implements MessageBody, FrameBody {

    private final ControlState state;

    public RequestEcoMaxControl(ControlState state) {
        this.state = state;
    }
    ...
    public byte[] getMessageData() {
        return new byte[] { (byte) state.getControlValue() };
    }

    @Override
    public FrameType getFrameType() {
        return FrameType.REQUEST_ECOMAX_CONTROL;
    }
}
