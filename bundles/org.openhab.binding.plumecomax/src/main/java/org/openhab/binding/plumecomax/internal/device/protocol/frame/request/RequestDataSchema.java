 ...
 */
public class RequestDataSchema implements MessageBody, FrameBody {

    public byte[] getMessageBody() {
        return new byte[] { FrameType.REQUEST_DATA_SCHEMA.getId() };
    }
    ...
    public FrameType getFrameType() {
        return FrameType.REQUEST_DATA_SCHEMA;
    }
}
